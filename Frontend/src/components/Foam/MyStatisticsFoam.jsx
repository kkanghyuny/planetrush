...
const MyStatistics = () => {
  ...
  let completeRate =
    stats.challengeCnt === 0
      ? 0
      : ((stats.completionCnt / stats.challengeCnt) * 100).toFixed(2);
  ...
  const categories = [
    {
      title: "전체",
      myAvg: stats.myTotalAvg,
      avg: stats.totalAvg,
      percentage: stats.myTotalPer,
    },
    {
      title: "운동",
      myAvg: stats.myExerciseAvg,
      avg: stats.exerciseAvg,
      percentage: stats.myExercisePer,
    },
    {
      title: "뷰티",
      myAvg: stats.myBeautyAvg,
      avg: stats.beautyAvg,
      percentage: stats.myBeautyPer,
    },
    {
      title: "생활",
      myAvg: stats.myLifeAvg,
      avg: stats.lifeAvg,
      percentage: stats.myLifePer,
    },
    {
      title: "공부",
      myAvg: stats.myStudyAvg,
      avg: stats.studyAvg,
      percentage: stats.myStudyPer,
    },
    {
      title: "기타",
      myAvg: stats.myEtcAvg,
      avg: stats.etcAvg,
      percentage: stats.myEtcPer,
    },
  ];
      ...
      {stats && (
        <div className="stats-container">
          <div className="cnt-container">
            <p>
              완료 횟수{" "}
              <span className="text-color">{stats.completionCnt}</span> 회
            </p>
            <p>
              챌린지 횟수{" "}
              <span className="text-color">{stats.challengeCnt}</span> 회
            </p>
          </div>
              ...
              {category.percentage !== 0 ? (
                <>
                  <Bar
                    ...
                    options={createBarOptions(category.myAvg, category.avg)}
                  />
                  <p>
                    내 평균은 상위{" "}
                    <span className="text-color">{category.percentage}%</span>
                    입니다.
                  </p>
                </>
              ) : (
